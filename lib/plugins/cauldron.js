 ...
 *
 * cauldron.js — Adds Cauldron Server support to Scales.js
 */
...
settings = {
	name: "Cauldron (Forge+Bukkit/Spigot)",
	stop: "stop",
	exe: "java",
	jar: "data/plugins/cauldron/cauldron.jar",
	cfg: "server.properties",
	trigger: {
		started: ')! For help, type "help" or "?"',
		eula: 'Go to eula.txt for more info.'
	},
	install_script: "cauldron_install.sh",
	log: "logs/latest.log",
	lastQuery: {}
}
